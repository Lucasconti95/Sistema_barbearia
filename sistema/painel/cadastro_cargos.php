...
<main>
<script src="cadastro_cargos.js"></script>
    ...
    <div class="container-fluid px-4">
        ...
        <div class="card mb-4">
            ...
            <a class="btn btn-primary" onclick='openCreateModal()'><i class="fa fa-plus" aria-hidden="true"></i> Novo cargo</a>
            </div>
            <!-- Fim Botão Modal -->
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="myModalLabel">Inserir Cargo</h4>
                        </div>
                        ...
                        <!-- Adicionamos um campo oculto para armazenar o ID do contrato em caso de edição -->
                         <input type="hidden" id="cargoId" name="cargoId">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a class="btn btn-danger" href="cadastro_cargos.php">Cancelar</a>
            ...
            <table id="datatablesSimple">
                    ...
                    <?php
                        try {
                        // Consulta SQL SELECT
                        $sql = "SELECT * FROM cargos WHERE ativo= 1 ";
                        ...
                        echo "<tr>";
                            ...
                            <a class='btn btn-sm btn-danger' href='javascript:void(0);' onclick='excluircargo($row[id])' title='Deletar'>
