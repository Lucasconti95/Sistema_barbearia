...
<main>
<script src="cadastro_grupo_acessos.js"></script>
    ...
    <div class="container-fluid px-4">
        ...
        <div class="card mb-4">
            ...
            <a class="btn btn-primary" onclick='openCreateModal()'><i class="fa fa-plus" aria-hidden="true"></i> Novo grupo</a>
            </div>
            <!-- Fim Botão Modal -->
                        ...
                        <form id="grupoForm" method="POST">
                            ...
                            <input type="hidden" id="grupoId" name="grupoId">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a class="btn btn-danger" href="cadastro_grupo_acessos.php">Cancelar</a>
            ...
            <table id="datatablesSimple">
                    ...
                    <?php
                        try {
                        // Consulta SQL SELECT
                        $sql = "SELECT * FROM grupo WHERE ativo= 1 ";
                        ...
                        echo "<tr>";
                            ...
                            <a class='btn btn-sm btn-danger' href='javascript:void(0);' onclick='excluirgrupo($row[id])' title='Deletar'>
