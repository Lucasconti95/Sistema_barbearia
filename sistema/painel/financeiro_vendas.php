    ...
    <div class="container-fluid px-4">
        ...
        <div class="card mb-4">
            ...
            <div class="card-header">
                <a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#meuModal"><i class="fa fa-plus" aria-hidden="true"></i> Nova Venda</a>
            </div>
            <!-- Fim Botão Modal -->
                        ...
                        <div class="modal-body">
                            ...
                            <form>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-3">
                                    <label for="nivel" class="form-label">Forma de PGTO</label>
                                        <select class="form-select" id="nivel" name="nivel" required>
                                            <option value="administrador">Pix</option>
                                            <option value="gerente">Debito</option>
                                            <option value="gerente">Credito</option>
