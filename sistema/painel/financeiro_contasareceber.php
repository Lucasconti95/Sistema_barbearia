...
<main>
    ...
    <div class="container-fluid px-4">
        ...
        <a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#meuModal"><i class="fa fa-plus" aria-hidden="true"></i> Nova Conta</a>
            </div>
            <!-- Fim Botão Modal -->
                                ...
                                <div class="col-md-6">
                                    ...
                                    <label for="nivel" class="form-label">Cliente</label>
                                        <select class="form-select" id="nivel" name="nivel" required>
                                            ...
                                            <option value="gerente">Cliente 3</option>
                                            <option value="gerente">Cliente 4</option>
