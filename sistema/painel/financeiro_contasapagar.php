                                ...
                                <label for="telefone" class="form-label">Descrição</label>
                                    ...
                                    <label for="nivel" class="form-label">Fornecedor</label>
                                        <select class="form-select" id="nivel" name="nivel" required>
                                            <option value="administrador">Fornecedor</option>
                                            <option value="gerente">Fornecedor 2</option>
                                            <option value="gerente">Fornecedor 3</option>
                                            <option value="gerente">Fornecedor 4</option>
                                                                        
                                            <!-- Adicione mais opções conforme necessário -->
                                        </select>
                                    </div>
                                    <div class="col-md-6">
                                    <label for="nivel" class="form-label">Funcionario</label>
                                        <select class="form-select" id="nivel" name="nivel" required>
                                            <option value="administrador">Funcionario</option>
                                            <option value="gerente">Funcionario 2</option>
                                            <option value="gerente">Funcionario 3</option>
                                            <option value="gerente">Funcionario 4</option>
